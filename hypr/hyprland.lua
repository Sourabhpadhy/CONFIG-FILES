...
-- --- LAYOUT & DIRECTION SWITCHES (Eval Method) ---

-- Switch to Dwindle layout globally
hl.bind(mainMod .. " + CTRL + D", hl.dsp.exec_cmd("hyprctl eval 'hl.config({ general = { layout = \"dwindle\" } })'")) 

-- Switch to Scrolling layout globally
hl.bind(mainMod .. " + CTRL + S", hl.dsp.exec_cmd("hyprctl eval 'hl.config({ general = { layout = \"scrolling\" } })'")) 

-- Set Scrolling Direction to Horizontal (Sets to Right)
hl.bind(mainMod .. " + CTRL + H", hl.dsp.exec_cmd("hyprctl eval 'hl.config({ scrolling = { direction = \"right\" } })'"))

-- Set Scrolling Direction to Vertical (Sets to Down)
hl.bind(mainMod .. " + CTRL + V", hl.dsp.exec_cmd("hyprctl eval 'hl.config({ scrolling = { direction = \"down\" } })'"))


-- --- SCROLLING LAYOUT BINDS ---
-- Moves view right (Scrolling: Pans right | Dwindle: Inactive)
hl.bind(mainMod .. " + CTRL + period", hl.dsp.layout("move +col"))
-- Moves view left (Scrolling: Pans left | Dwindle: Inactive)
hl.bind(mainMod .. " + CTRL + comma", hl.dsp.layout("move -col"))
-- Swaps column right (Scrolling: Moves active column right | Dwindle: Inactive)
hl.bind(mainMod .. " + CTRL + SHIFT + period", hl.dsp.layout("swapcol r"))
-- Swaps column left (Scrolling: Moves active column left | Dwindle: Inactive)
hl.bind(mainMod .. " + CTRL + SHIFT + comma", hl.dsp.layout("swapcol l"))
-- Resize up (Scrolling: Expands column to next config width | Dwindle: Inactive)
hl.bind(mainMod .. " + CTRL + bracketright", hl.dsp.layout("colresize +conf"))
-- Resize down (Scrolling: Shrinks column to prev config width | Dwindle: Inactive)
hl.bind(mainMod .. " + CTRL + bracketleft", hl.dsp.layout("colresize -conf"))
-- Fit active (Scrolling: Fits current column fully into view | Dwindle: Inactive)
hl.bind(mainMod .. " + CTRL + F", hl.dsp.layout("fit active"))


-- --- DWINDLE LAYOUT BINDS ---
-- Toggle Split (Dwindle: Flips split direction from horizontal to vertical | Scrolling: Inactive)
...
dofile("/home/sourabh/.cache/qswitch/qswitch.lua")
